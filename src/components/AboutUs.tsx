...
export default function AboutUs({ openWhatsApp }: AboutUsProps) {
  return (
    <section id="about" className="py-20 overflow-hidden bg-gradient-to-br from-white via-orange-50 to-yellow-50">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 text-base md:text-lg leading-8 mb-8">
              Our main goal is simple — to make every journey smooth, punctual, and stress-free for every passenger.
              We believe in honest service, clean vehicles, professional driving, and customer satisfaction above everything else.
            </p>
            ...
            <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 p-6 md:p-8">
              ...
              <div className="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-2xl p-5 border border-orange-100 mb-6">
                <p className="text-gray-700 italic leading-7">
                  “Our service is built on trust, punctuality, and comfort. Every journey
                  should feel safe, affordable, and hassle-free.”
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  <span className="text-xl">✅</span>
                  <div>
                    <p className="font-semibold text-gray-900">Flexible Travel Options</p>
                    <p className="text-sm text-gray-500">
