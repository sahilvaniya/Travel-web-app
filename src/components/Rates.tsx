...
export default function Rates({ openWhatsApp }: RatesProps) {
  ...
  const model =
    vehicleType === "SUV" ? "Ertiga / Innova" : "Dzire / Etios";

  openWhatsApp(
    `Hello! 🙏

I need a ${vehicleType} cab from Ahmedabad to ${row.city}.
...
Date & Time:`
  ...
  <button
    ...
    className="bg-orange-500 hover:bg-orange-600 text-white text-sm font-semibold px-4 py-2 rounded-xl transition-all hover:scale-105"
  >
    Book SUV
  </button>
  ...
  <button
    ...
    className="bg-blue-500 hover:bg-blue-600 text-white text-sm font-semibold px-4 py-2 rounded-xl transition-all hover:scale-105"
  >
    Book Sedan
  </button>
</div>
