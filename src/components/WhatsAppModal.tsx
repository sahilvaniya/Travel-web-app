...
export default function WhatsAppModal({ message, onConfirm, onClose }: WhatsAppModalProps) {
  return (
    <div
    ...
    >
      <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full overflow-hidden animate-modal">
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-xs leading-relaxed">
                  Once you press <strong>“Confirm”</strong>, you’ll be redirected to WhatsApp to
                  send your booking details to our number <strong>+91 9106178900</strong>.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="px-6 pb-6 flex flex-col sm:flex-row gap-3">
          <button
            onClick={onClose}
            className="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-3.5 px-5 rounded-2xl transition-colors"
          >
            ✕ Go Back
          </button>
          <button
